...
class Params():
    def __init__(self):#,small,k):
        ...
        self.t_max = 10.
        self.dt = 0.002 #1./self.nz
        self.tsteps = int(self.t_max/self.dt)
        self.nslices = 101#self.tsteps
        ...
        self.shear = 'simple'
        self.superName = 'Segregation_Example/'#seed_' + str(self.seed)
        buildColorMap(self)
...
#        make_pcolor(image_store,self)
    ...
    def everyNTimestepsPlots(self,s,N):
        pass

    def everyNslicesPlots(self,s,tstep):
        pass

    def afterEachShufflePlots(self,s,nsims,n):
        pass
